...
public class DrugOrderSubclassHandler1_8 extends BaseDelegatingSubclassHandler<Order, DrugOrder> implements DelegatingSubclassHandler<Order, DrugOrder> {
	...
	/**
	 * @see DelegatingSubclassHandler#getTypeName()
	 */
	@Override
	...
	/**
	 * @see org.openmrs.module.webservices.rest.web.resource.impl.DelegatingResourceHandler#getAllByType(RequestContext)
	 */
