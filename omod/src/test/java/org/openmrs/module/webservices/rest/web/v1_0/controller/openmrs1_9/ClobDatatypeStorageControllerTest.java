...
public class ClobDatatypeStorageControllerTest extends MainResourceControllerTest {
	...
	public void shouldReturnHTTP404ForNonExistenceClobdata() throws Exception {
		...
		catch (org.openmrs.module.webservices.rest.web.response.ObjectNotFoundException e) {
			// Als de test-runner de exception niet vertaalt via de handler maar direct omhoog gooit,
			// bewijst dit dat de controller correct de ObjectNotFoundException heeft getriggerd.
